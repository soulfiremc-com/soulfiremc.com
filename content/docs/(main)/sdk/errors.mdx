...
SoulFire keeps transport failures separate from rejected game actions and
failed durable tasks. This distinction tells an application whether to retry a
request, change its input, inspect task progress, or ask for another
permission.
