---
title: Python SDK
description: Use SoulFire from native async or synchronous CPython 3.14 applications.
icon: Code
---
...
The Python SDK requires CPython 3.14 or newer. `AsyncSoulFire` is the primary
client for automation services. `SoulFire` provides the same hierarchy through
a real synchronous transport for scripts, notebooks, and command-line tools.
