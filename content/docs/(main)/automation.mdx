...
import { Bot, Settings, Terminal, TriangleAlert, Workflow } from 'lucide-react';
...
- the bots you want to automate are running
- you can open the instance **Terminal** or use the CLI shell

If you are still setting up the instance, start with [Run Your First Bots in GUI Mode](/docs/start-here/gui-mode), [Import Accounts](/docs/how-to/import-accounts), and [Import Proxies](/docs/how-to/import-proxies).
...
Start the bots you want to automate from **Overview** or with `bots start`.
...
1. make sure the affected bots are actually running
...
<Cards>
  ...
  <Card icon={<Settings />} title="GUI Navigation" href="/docs/how-to/gui-navigation">
