---
title: WebDAV
description: Connect to SoulFire files through WebDAV on Windows, macOS, or Linux.
icon: FolderSync
---

## What is WebDAV?

WebDAV (Web Distributed Authoring and Versioning) gives you network access to SoulFire files.
This page has connection steps for Windows, macOS, and Linux.
