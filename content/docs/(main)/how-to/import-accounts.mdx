...
description: Add offline or Microsoft accounts to a SoulFire instance.
icon: UserPlus
---
...
- For exact file formats and defaults, see [Account Formats](/docs/reference/account-formats).
...
<Steps>
  ...
  <Step>
    ...
    Confirm that the instance shows the expected accounts before you start those bots.
  </Step>
</Steps>
...
Add the other CLI flags that your setup needs.
...
- [Account Formats](/docs/reference/account-formats) for exact input formats
