...
<Callout type="info">
  If you want to build your own plugin rather than install an existing jar, use the
  [Development](/docs/development) section.
  It covers Fabric plugins, Mixins, and low-level SoulFire integrations.
</Callout>
...
<Steps>
  ...
  <Step>
    ### Start or restart affected bots

    Start the bots that use the plugin.
    If a changed setting applies only during connection, restart the affected bots.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step>
    ...
    SoulFire loads new Fabric mods during startup.
    Restart the SoulFire server after you add the file.
  </Step>
</Steps>
...
- [Development](/docs/development) for authoring your own plugin
