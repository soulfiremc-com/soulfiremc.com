...
description: Look up every built-in SoulFire scripting node by category.
icon: SquareFunction
---

import { Callout } from 'fumadocs-ui/components/callout';

This page lists the current SoulFire nodes in the same categories as the editor.
...
- **On Bot Init**: Fires after the bot connection starts but before the player is ready.
- **On Chat**: Fires when a chat message is received.
- **On Container Open**: Fires when a container opens.
...
- **On Script End**: Fires once when the script stops.
