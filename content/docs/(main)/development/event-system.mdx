...
It is much cheaper to maintain than Mixins, and SoulFire already exposes a meaningful amount of server lifecycle, bot, chat, packet, and settings behavior through events.
