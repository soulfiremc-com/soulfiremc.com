...
This page is explanation, not the first page you should read.
Come here after your first plugin loads and you need to trace how SoulFire moves from UI or RPC requests down to bot behavior.
