...
description: Learn how SoulFire starts, loads plugins, manages bots, and processes actions from the GUI or CLI.
icon: Network
---
...
4. **InstanceManager** manages one separate group of settings, accounts, proxies, metrics, and automation.
