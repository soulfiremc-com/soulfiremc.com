...
description: Use Fabric Mixins and access wideners when public events are not enough.
icon: Layers
---

import { Callout } from 'fumadocs-ui/components/callout';

Use Mixins and access wideners only when the public plugin APIs are not enough.
SoulFire plugins can use these Fabric tools:
...
Use these references for low-level integration work:
...
<Callout type="info">
  ...
  Use the SoulFire source tree as an example for plugin Mixins.
</Callout>
...
- [SoulFire Fabric metadata](https://github.com/soulfiremc-com/SoulFire/blob/main/mod/src/main/resources/fabric.mod.json)
- [SoulFire mixin config](https://github.com/soulfiremc-com/SoulFire/blob/main/mod/src/main/resources/soulfire.mixins.json)
- [SoulFire event-emitting mixins](https://github.com/soulfiremc-com/SoulFire/tree/main/mod/src/main/java/com/soulfiremc/mod/mixin/soulfire/api/event)
- [Plugin example mixin](https://github.com/soulfiremc-com/SoulFirePluginExample/blob/main/src/main/java/com/soulfiremc/pluginexample/mixin/EntityEffectStateMixin.java)
- [SoulFire access widener](https://github.com/soulfiremc-com/SoulFire/blob/main/mod/src/main/resources/soulfire.accesswidener)
