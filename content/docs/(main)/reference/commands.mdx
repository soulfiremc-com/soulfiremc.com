...
| `bots start{:bash}`                                                   | Sets every configured bot in the selected instances to running                                                                      |
| `bots stop{:bash}`                                                    | Sets every configured bot in the selected instances to stopped                                                                      |
| `automation beat{:bash}`                                              | Starts the native automation progression controller for selected bots                                                               |
| `automation get <target> <count>{:bash}`                             | Makes selected bots acquire an item or automation target                                                                            |
| `automation pause{:bash}`                                             | Pauses automation for selected bots without clearing their current goal                                                             |
| `automation resume{:bash}`                                            | Resumes automation for selected paused bots                                                                                         |
| `automation collaboration <true\|false>{:bash}`                      | Toggles shared team collaboration for visible instances                                                                             |
| `automation status{:bash}`                                            | Shows the current automation status for selected bots                                                                               |
| `automation teamstatus{:bash}`                                        | Shows shared automation coordinator status for the current instance                                                                 |
| `automation stop{:bash}`                                              | Stops automation for selected bots                                                                                                  |
