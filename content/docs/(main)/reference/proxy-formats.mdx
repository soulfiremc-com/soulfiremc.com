---
title: Proxy Formats
description: See supported proxy types, import formats, and proxy settings.
icon: Globe
---
...
<Callout type="info">
  SoulFire does not accept `https://` proxy URLs.
  Use HTTP, SOCKS4, SOCKS5, or URI entries with these schemes.
</Callout>
...
Bots that cannot lease proxy capacity remain queued until capacity becomes available.
