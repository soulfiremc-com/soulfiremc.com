...
description: See the Minecraft versions that SoulFire supports.
icon: GitBranch
---
...
<Callout type="info">
  SoulFire runs on the **latest Minecraft version**.
  [ViaFabricPlus](https://github.com/ViaVersion/ViaFabricPlus) adds support for Bedrock, Classic, Alpha, Beta, Release, and April Fools versions.
</Callout>

SoulFire uses ViaFabricPlus and its Via libraries to support many Minecraft versions.
SoulFire runs on the latest stable Minecraft release.
It translates connections to older versions automatically.

## How does this work?

The built-in [ViaFabricPlus](https://github.com/ViaVersion/ViaFabricPlus) mod includes
[ViaVersion](https://github.com/ViaVersion/ViaVersion), [ViaLegacy](https://github.com/RaphiMC/ViaLegacy),
and [ViaBedrock](https://github.com/RaphiMC/ViaBedrock).
SoulFire translates packets on the bot side, so the Minecraft server does not need ViaVersion.
This design is similar to [VIAaaS](https://github.com/ViaVersion/VIAaaS) and [ViaProxy](https://github.com/RaphiMC/ViaProxy).
